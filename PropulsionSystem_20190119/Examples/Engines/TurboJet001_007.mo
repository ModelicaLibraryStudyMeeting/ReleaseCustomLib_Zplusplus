...
equation
  connect(ramp_rating.y, combustFuel1.dm_fuel_in) annotation(
    Line(points = {{12, 30}, {18, 30}, {18, 6}, {40, 6}, {40, 6}}, color = {0, 0, 127}));
  connect(pipe.port_b, Nzl070.port_1) annotation(
    Line(points = {{150, -30}, {154, -30}, {154, -22}, {160, -22}, {160, -22}}, color = {0, 127, 255}));
