...
partial model HeatInjector_Base
  ...
  ********************************************************/
  ...
  type switchCausality_HeatInjection= enumeration
              (
                input_dq "",
                input_TtOutlet ""
              ) 
  ...
  //----- switches -----
  parameter switchCausality_HeatInjection switchCausality_dq 
    = switchCausality_HeatInjection.input_TtOutlet 
    ""
    annotation(
    Dialog(group = "switch"),
  ...
  Modelica.SIunits.HeatFlowRate dqInjected(start= dqInjectedDes) "";
...
********************************************************/
  ...
  annotation(
    Icon(graphics = {Polygon(origin = {-31, 12}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, points = {{111, 30}, {47, 30}, {-7, 26}, {-35, 20}, {-47, 8}, {-49, -12}, {-45, -32}, {-35, -42}, {-1, -48}, {47, -50}, {111, -50}, {111, 30}}), Rectangle(origin = {-76, 69}, fillColor = {118, 118, 118}, fillPattern = FillPattern.Solid, extent = {{-2, 13}, {2, -49}}), Rectangle(origin = {78, 69}, fillColor = {93, 93, 93}, fillPattern = FillPattern.Solid, extent = {{-2, 13}, {2, -27}}), Rectangle(origin = {105, 80}, rotation = -90, fillColor = {68, 68, 68}, fillPattern = FillPattern.Solid, extent = {{-2, -5}, {2, -29}}), Text(origin = {-37, -91}, extent = {{-63, 11}, {97, -9}}, textString = "%name"), Rectangle(origin = {-51, 81}, rotation = -90, fillColor = {118, 118, 118}, fillPattern = FillPattern.Solid, extent = {{-2, -23}, {2, -49}}), Line(origin = {-0.320122, 73.7199}, points = {{0, 17}, {0, -69}}, thickness = 2, arrow = {Arrow.None, Arrow.Open}, arrowSize = 10), Text(origin = {12, 62}, extent = {{-12, 10}, {12, -10}}, textString = "dq"), Line(origin = {68.168, -64.008}, points = {{1, 27}, {1, -25}})}, coordinateSystem(initialScale = 0.1)));
