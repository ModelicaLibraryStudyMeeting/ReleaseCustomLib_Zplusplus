...
model Inlet
  ...
  ********************************************************/
  ...
  //----- switches -----
  parameter PropulsionSystem.Types.switches.switch_parameter_input switchInput_effRam = PropulsionSystem.Types.switches.switch_parameter_input.use_desValue "" annotation(
    Dialog(group = "switch"),
    choicesAllMatching = true,
    Evaluate = true,
    HideResult = true);
  parameter switch_Inlet_Subelement switchSubelement_effRam = switch_Inlet_Subelement.NoSubelement "" annotation(
    Dialog(group = "switch"),
    choicesAllMatching = true,
    Evaluate = true,
    HideResult = true);
