...
********************************************************/
  ...
  annotation(
    Icon(graphics = {Polygon(origin = {0, 10}, fillColor = {255, 221, 96}, fillPattern = FillPattern.Solid, points = {{-80, 70}, {-80, -90}, {60, -50}, {60, 30}, {-80, 70}}), Text(origin = {-62, 10}, extent = {{-18, 0}, {102, -20}}, textString = "%name"), Line(origin = {60.02, 77.5}, points = {{0, 22}, {0, -38}})}, coordinateSystem(initialScale = 0.1)),
