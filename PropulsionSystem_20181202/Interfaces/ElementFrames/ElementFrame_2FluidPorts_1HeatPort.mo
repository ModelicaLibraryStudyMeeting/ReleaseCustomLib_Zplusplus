...
partial model ElementFrame_2FluidPorts_1HeatPort
  ...
  ********************************************************/
  ...
  parameter Modelica.SIunits.Area Amech_2= 1.0
    annotation(Dialog(group = "Geometry"));
  //********** Internal variables **********
  Medium.BaseProperties fluid_1 "flow station of inlet with isentropic compression";
  Medium.BaseProperties fluid_2 "flow station of outlet with isentropic compression";
  ...
  //********** Initialization **********
  parameter Medium.AbsolutePressure p_1_start= 101.3*1000
    "Start value of pressure at port a"
    annotation(Dialog(tab = "Initialization"));
  parameter Medium.AbsolutePressure p_2_start= 101.3*1000*0.99
